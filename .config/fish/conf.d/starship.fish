# Cached output of: starship init fish --print-full-init
# Regenerate with: /opt/homebrew/bin/starship init fish --print-full-init > ~/.config/fish/conf.d/starship.fish
